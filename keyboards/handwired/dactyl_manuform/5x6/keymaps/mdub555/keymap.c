...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //                     KC_ESC,KC_LGUI,                                                 KC_LBRC, KC_RBRC,
  //                                    KC_ENT, KC_LSFT,                 KC_BSPC, KC_SPC,
  //                                    KC_LCTL,KC_LALT,                 KC_RALT,KC_RCTL,
  //                                    TT(1)  , TT(2) ,                 KC_ESC , KC_DEL
  // ),
	[_QWERTY] = LAYOUT_5x6(
     KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
     KC_CAPS, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_EQL,
  ...
  //    TO(0)  ,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,KC_PSCR,                 XXXXXXX, KC_P1 , KC_P2 , KC_P3 ,KC_EQL ,KC_UNDS,
  ...
  // ),
	[_LOWER] = LAYOUT_5x6(
     KC_TILD, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_PAST, KC_LPRN, KC_RPRN, KC_DEL,
  ...
  //    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,KC_MUTE,                 XXXXXXX,KC_LEFT,KC_DOWN, KC_UP ,KC_RGHT,XXXXXXX,
  //    XXXXXXX,KC_BRIU,KC_MPRV,KC_MPLY,KC_MNXT,KC_VOLU,                 XXXXXXX,KC_MS_L,KC_MS_D,KC_MS_U,KC_MS_R,XXXXXXX,
